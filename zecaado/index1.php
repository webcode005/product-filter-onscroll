...
$all_sale_price=$db->query("SELECT distinct sale_price FROM `products` WHERE category_id = '1' GROUP BY sale_price");
    ...
    <div class="row">
        ...
        <aside class="col-lg-3 col-md-4">
        	<div class="panel list">
                <div class="panel-heading"><h3 class="panel-title">Shop by Price</h3></div>
     ...
     <input type="hidden" id="hidden_minimum_price" value="0" />
            ...
            <div class="panel list">
                <div class="panel-heading"><h3 class="panel-title">Shop by Color</h3></div>
                <div class="panel-body collapse in" id="panelOne">
                    <ul class="list-group">
